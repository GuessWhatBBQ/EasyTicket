function viewSeatsReset(buttonID){
    // console.log("View Seats button is clicked from reset.");
    
    var viewLayoutButton = document.getElementById(`${buttonID}`); //this is the button that is clicked to view/hide seats
    
    if(viewLayoutButton.innerText === 'Hide Seats') //this is 'Hide Seats' because the viewSeats function alters the innerText before this block is run
    {   
...
function resetGreenSeats(){             //clears all selected seats
    ...
    console.log('greenSeats are reset');
}